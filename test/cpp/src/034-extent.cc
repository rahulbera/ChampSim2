...
TEMPLATE_TEST_CASE_SIG("Static extents that are subsets can be unioned", "", ((champsim::data::bits V, champsim::data::bits W), V, W), (8_b, 4_b), (12_b, 4_b),
                       (16_b, 4_b), (20_b, 4_b), (24_b, 4_b), (28_b, 4_b), (12_b, 8_b), (16_b, 8_b), (20_b, 8_b), (24_b, 8_b), (28_b, 8_b), (16_b, 12_b),
                       (20_b, 12_b), (24_b, 12_b), (28_b, 12_b), (20_b, 16_b), (24_b, 16_b), (28_b, 16_b), (24_b, 20_b), (28_b, 20_b), (28_b, 24_b))
{
...
{
  auto [v, w] =
      GENERATE(as<std::pair<champsim::data::bits, champsim::data::bits>>{}, std::pair{8_b, 4_b}, std::pair{12_b, 4_b}, std::pair{16_b, 4_b},
               std::pair{20_b, 4_b}, std::pair{24_b, 4_b}, std::pair{28_b, 4_b}, std::pair{12_b, 8_b}, std::pair{16_b, 8_b}, std::pair{20_b, 8_b},
               std::pair{24_b, 8_b}, std::pair{28_b, 8_b}, std::pair{16_b, 12_b}, std::pair{20_b, 12_b}, std::pair{24_b, 12_b}, std::pair{28_b, 12_b},
               std::pair{20_b, 16_b}, std::pair{24_b, 16_b}, std::pair{28_b, 16_b}, std::pair{24_b, 20_b}, std::pair{28_b, 20_b}, std::pair{28_b, 24_b});
...
TEMPLATE_TEST_CASE_SIG("The union of adjacent mismatched extents is bounded by the maximum and minimum", "", ((champsim::data::bits V), V), 4_b, 8_b, 12_b,
                       16_b, 20_b, 24_b, 28_b)
{
  champsim::static_extent<32_b, V> lhs{};
  champsim::dynamic_extent rhs{V, 0_b};
...
TEMPLATE_TEST_CASE_SIG("Static extents can be subextented", "", ((champsim::data::bits V, champsim::data::bits W), V, W), (8_b, 4_b), (12_b, 4_b), (16_b, 4_b),
                       (20_b, 4_b), (24_b, 4_b), (28_b, 4_b), (12_b, 8_b), (16_b, 8_b), (20_b, 8_b), (24_b, 8_b), (28_b, 8_b), (16_b, 12_b), (20_b, 12_b),
                       (24_b, 12_b), (28_b, 12_b), (20_b, 16_b), (24_b, 16_b), (28_b, 16_b), (24_b, 20_b), (28_b, 20_b), (28_b, 24_b))
{
  {
    champsim::static_extent<32_b, 0_b> lhs{};
    champsim::static_extent<V, W> rhs{};
...
TEMPLATE_TEST_CASE_SIG("Static extents do not overflow when subextented", "", ((champsim::data::bits V, champsim::data::bits W), V, W), (8_b, 4_b), (12_b, 4_b),
                       (16_b, 4_b), (20_b, 4_b), (24_b, 4_b), (28_b, 4_b), (12_b, 8_b), (16_b, 8_b), (20_b, 8_b), (24_b, 8_b), (28_b, 8_b), (16_b, 12_b),
                       (20_b, 12_b), (24_b, 12_b), (28_b, 12_b), (20_b, 16_b), (24_b, 16_b), (28_b, 16_b), (24_b, 20_b), (28_b, 20_b), (28_b, 24_b))
{
