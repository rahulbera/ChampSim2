...
TEST_CASE("Invalid set-dueling geometries are rejected with their set counts")
{
  REQUIRE_THROWS_WITH(champsim::msl::get_sample_rate(7), Catch::Matchers::ContainsSubstring("7"));
  REQUIRE_THROWS_WITH(champsim::msl::get_num_samples(10), Catch::Matchers::ContainsSubstring("10"));
}
