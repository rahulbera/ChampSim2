...
struct config {
  ...
  static constexpr int LOGG = 10;   // log2 entries per table
...
void ittage_64kb::update_btb(champsim::address ip, champsim::address branch_target, bool taken, uint8_t branch_type)
{
