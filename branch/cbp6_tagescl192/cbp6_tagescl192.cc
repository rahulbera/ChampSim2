...
void cbp6_tagescl192::branch_predictor_final_stats()
{
...
void cbp6_tagescl192::branch_execute_resolve(uint64_t instr_id, champsim::address /*ip*/, champsim::address /*branch_target*/, bool /*taken*/, uint8_t /*branch_type*/)
{
